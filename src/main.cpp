...
int main(void) {
  ...
  CWaypoint amsterdam(52.3680, 4.9036, "amsterdam"),
      ...
      berlin(52.5166, 13.4050, "berlin"), tokio(35.6895, 139.6917, "tokio");
  ...
  std::cout << "Name: " << name << "Latitude: " << latitude
            << "Longitude: " << longitude << std::endl;
  /*Result: Name: 0x70fc40 (Size: 32 bytes), Latitude: 0x70fc38 (Size:8 bytes),
   * Longitude: 0x70fc30 (Size: 8 bytes) */

  /* Test case for getAllDataByReference*/
  // std::cout << "Name: " << &name << "Latitude: " << &latitude << "Longitude:
  // " << &longitude << std::endl;
  tokio.getAllDataByReference(name, latitude, longitude);
  /*Result: The addresses and values of the local variables and the parameter
  ...
  /* Test case to calculate distance between Amsterdam and Berlin, Berlin and
   * Tokio*/
  std::cout << "TC: Distance b/w Amsterdam and Berlin = "
            << amsterdam.calculateDistance(berlin) << std::endl;
  std::cout << "TC: Distance b/w Berlin and Tokio = "
