...
private:
  ...
  /**
       ...
       * Expected Result: Addition of the waypoints failes due to size
   * constraints
  ...
  /**
       ...
       * Expected Result: All POIs would be successfully added, provided the
   * size
  ...
  /**
       * Test case to add more POIs than the specified limit to the POI
   * Database.
  ...
  /**
       ...
       * Expected Result: Unable to set the Database connection. Route addition
   * fails
       * @param  None
       * @return None
       */
