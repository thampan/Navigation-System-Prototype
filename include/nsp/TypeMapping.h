...
#define MAX_POI_ATTRIBUTES                                                     \
  (5) /**< \brief Represents Max number of POI Attributes */
#define MAX_WAYPOINT_ATTRIBUTES                                                \
  (3) /**< \brief Represents Max number of Waypoint Attributes */
 ...
 * converting from one type to another. There is no storage involved and hence
 * all
...
typedef enum {
  ...
  RC_INVALID_DESCRIPTION, /**< \brief Represents Error of type Invalid
                             description */
  ...
  RC_INCORRECT_NUMBER_OF_ATTRIBUTES, /**< \brief Represents Error of type
