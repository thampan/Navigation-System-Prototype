...
* 					This class represents Point of Interests
*which may
* 					optionally be present in a route. A CPOI
*object is
* 					contained in the CPOIDatabase class. The
*CPOI class
...
public:
  ...
  /**
       ...
       * Initializes all the data members with the values provided or with the
   * default values
       * @param t_poi type 			  - type of the POI object
   * [IN] Default: UNKNOWN
       * @param std::string name 		  - Name of the POI object
   * [IN] Default: EMPTY_STRING
       * @param std::string description - Description of the POI object
   * [IN] Default: EMPTY_STRING
   ...
   * [IN] Default: 0.0
       */
  CPOI(t_poi type = UNKNOWN, std::string name = DEFAULT_STRING,
       std::string description = DEFAULT_STRING, double latitude = 0.0,
   ...
   * [IN]
       ...
       */
  bool set(CPOI::t_poi type, std::string name, std::string description,
   ...
   * @param  std::ostream& stream [OUT] - The ostream object where the POI data
   * is to be pushed into
